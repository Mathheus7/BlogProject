import logo from '../../assets/img/svg/blog-logo2.svg';
                ...
                <section className="container pb-0 ">
                    ...
                    <div className="row pb-3 bb-black">
                        ...
                        <div className="grid-3">
                            ...
                            <div className="flex-start-column mt-2">
                                ...
                                <a href="/" className="color-gray link-footer">Moda</a>
                                <a href="/" className="color-gray link-footer">Outros</a>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="grid-9">
                            <p>2023 | Todos os direitos reservados. Projeto de React.js do curso <a
                                href="https://www.frontpush.com.br/" target="blank">FrontPUSH.</a></p>
                        </div>
